...
const MotDeBruno = () => {
  return (
    <div className="px-5 md:px-10 lg:w-1/2 mx-auto text-center mt-32">
      <h2 className="text-4xl font-semibold">Le mot de Bruno</h2>
      <p className="mt-8">
        Lorsque Patrick & Jean-Louis m&#39;ont proposé de rejoindre EMOVIN,
      ...
      <p className="font-caveat text-3xl mt-8">À très vite, Bruno</p>
    </div>
  );
};

export default MotDeBruno;
