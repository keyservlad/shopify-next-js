    ...
    switch (plateforme) {
      case "Chronopost":
        return (
          <>
            <p>
              Vos boxes seront livrées à la plateforme du point relais
              Chronopost le plus proche de chez vous
            </p>
            <button
              onClick={() => {
                setIsContactFormOpen(true);
              }}
              className="text-left w-full underline cursor-pointer mt-2"
            >
