...
const ProductCard = ({ product }) => {
  ...
  // TODO mettre ca cote serveur pour opti + FIX bug recommendations toujours les memes (en modifiant la collection qui va match avec "blanc" par exemple et non pas notre cave)
