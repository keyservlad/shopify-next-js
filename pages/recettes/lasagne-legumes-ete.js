    ...
    fourneaux: (
      <>
        ...
        <p>
          ...
          badigeonner d&#39;huile d&#39;olive et assaisonner. Faire griller au
          BBQ sur les 2 faces.
        </p>

        <p>
          Emincer le fenouil et faire revenir à la poêle jusqu&#39;à ce
          qu&#39;il soit doré. (Rajouter éventuellement un peu d&#39;eau et
          couvrir).
        </p>
        <p>Le fenouil doit être bien moelleux.</p>
        <p>
          Cuire les poivrons au gril jusqu&#39;à ce que la peau noircisse et
          gonfle, mettre dans un plastique fermé quelques minutes, puis enlever
          la peau.
        </p>
        <p>
          <span className="font-semibold"> Béchamel :</span> Faire fondre le
          beurre et ajouter la farine, remuer avec un fouet, ajouter le lait,
          bien remuer au fouet pour éviter les grumeaux. Quand la sauce a
          épaissi, ajouter le concentré de tomate, laisser cuire à feu doux 2
          minutes et retirer du feu. Ajouter les fromages, et remuer jusqu&#39;à
          ce qu&#39;ils soient bien fondus.
        </p>
        <p>
      ...
      text: (
        <>
          ...
          <p className="text-redWine mt-7">
            ...
            caractère mais sans excès pour s&#39;accorder sans le dominer ce
            plat aux «&nbsp;accents italiens&nbsp;» et plein de
            gourmandises.&nbsp;»
          </p>
