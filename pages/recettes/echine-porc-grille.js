    ...
    fourneaux: (
      <>
        ...
        <p>
          ...
          au pilon. Mixer tous les ingrédients de la marinade et faire mariner
          les échines de porc au réfrigérateur pendant au moins 2 heures
        ...
        <p className="mt-3">
          Griller les échines au BBQ. Au 2/3 de cuisson, mettre les échines dans
          1 ou 2 poêles avec la marinade et terminer la cuisson à feu doux ou
          moyen en retournant souvent. (Attention : la marinade doit être
          caramélisée mais pas brûlée).
        </p>

        <p className="font-bold mt-3">Dressage</p>
        <p>
          Déposer sur un côté de l&#39;assiette une belle portion
          d&#39;aubergine surmontée d&#39;une petite salade d&#39;herbes
          fraîches à l&#39;huile (chaud ou froid selon les goûts.) Placer
          l&#39;échine de l&#39;autre côté. Arroser avec la marinade restante et
          saupoudrer de graines de sésame toastées et d&#39;olives noires
          émincées.
        </p>
      </>
    ),
      ...
      text: (
        <>
          ...
          <p className="text-redWine mt-7">
            « Issu de vieilles vignes de gamay (70-100 ans), un vin gourmand
            sans lourdeur, aux tanins bien fondus. Une belle complexité
            aromatique sur des notes de fruits rouges et d&#39;épices et qui
            viendront délicieusement se fondrent avec le jus aigre doux-romarin
            de l&#39;échine de porc tout en apportant un équilibre aromatique
            avec l&#39;aubergine fumée à l&#39;ail ».
          </p>
          <p>
