    ...
    fourneaux: (
      <>
        ...
        <p>
          ...
          bouillante salée en gardant une texture ferme et une belle couleur
          verte : les plonger dans un bain d&#39;eau glacée. Renouveler la
          procédure pour les haricots beurre.
        </p>
        <p>
          Couper les patates douces en tranches de 1 cm d&#39;épaisseur et
          griller au BBQ (sans huile).
        </p>
      ...
      text: (
        <>
          ...
          <p className="text-redWine mt-7">
            «&nbsp;Sauvignon blanc et Sauvignon gris nous offrent un bel
            équilibre de saveur et fraicheur pour accompagner cette salade
            végétarienne aux douceurs méditerranéennes.&nbsp;»
          </p>
