  ...
  const recette = {
    ...
    fourneaux: (
      <>
        ...
        <p>
          Mettre tous les ingrédients de la marinade dans un bol et bien
          mélanger.
          <br />
          Badigeonner les pintades avec la marinade à l&#39;aide d&#39;un
          pinceau alimentaire.
          <br />
        ...
        <p className="mt-3">
          Mettre cette préparation dans les ramequins et enfourner dans un plat
          en couvrant d&#39;eau à mi-hauteur les ramequins.
          <br />
        ...
        <p className="mt-3">
          ...
          déposer au fond d&#39;une cocotte et placez les pintades sur le
          dessus. <br />
          Ajouter le vin blanc, la feuille de laurier et le thym, couvrer avec
          un couvercle et enfourner pendant environ 30 minutes. <br />
          Ajouter le bouillon et faites cuire encore 15 à 20 minutes.
        </p>
        <p className="mt-3">
          Réchauffer les puddings au four ou sur la plaque dans leur bain-marie
          à feu doux.
        </p>
        ...
        <p className="">
          Répartissez les pommes de terre sur chaque assiette surmontée
          d&#39;une cuisse et d&#39;un suprème de pintade, ajouter un pudding
          par assiete et arroser avec le jus de cuisson.
        </p>
      </>
    ),
    recommande: {
      text: (
        <>
          ...
          <p className="text-redWine mt-7">
            Son passage de 12 mois en barrique lui apporte élégance et
            Générosité. Sa complexité et sa gourmandise lui viennent d&#39;une
            sélection minutieuse des meilleures parcelles&nbsp;!
            <br />
          ...
          <p className="mt-7">
            <strong>
              ...
              propose une Box de 3 bouteilles au doux prix de 42€ TTC,{" "}
            </strong>
